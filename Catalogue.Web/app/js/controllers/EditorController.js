...
(function() {
  var addOpenDataResource, fakeValidationData, getDataFormatObj, getOpenDataButtonText, getOpenDataButtonToolTip, getPendingSignOff, getSecurityText, isFilePath, removeOpenDataResource, trimDoubleQuotes, updateDataFormatObj;
  ...
  addOpenDataResource = function(record) {
    ...
    return console.log(record.publication.openData.resources.length);
  };

  removeOpenDataResource = function(record, resource) {
    return record.publication.openData.resources.splice($.inArray(resource, record.publication.openData.resources), 1);
  };
