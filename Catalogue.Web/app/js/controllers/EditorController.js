...
(function() {
  var fakeValidationData, getDataFormatObj, getOpenDataButtonText, getOpenDataButtonToolTip, getPendingSignOff, getSecurityText, isAssessedAndUpToDate, isSignedOffAndUpToDate, isUploadedAndUpToDate, updateDataFormatObj;
  ...
  getOpenDataButtonToolTip = function(record) {
  ...
  getOpenDataButtonText = function(record) {
    if (record.publication === null) {
