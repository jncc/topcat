...
(function() {
  var fakeValidationData, getDataFormatObj, getNextPublishableValue, getOpenDataButtonText, getOpenDataButtonToolTip, getPendingSignOff, getPublishableText, getSecurityText, isFilePath, updateDataFormatObj;
  ...
  getNextPublishableValue = function(n) {
    switch (n) {
      case void 0:
      case null:
        return true;
