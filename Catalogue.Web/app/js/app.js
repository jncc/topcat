(function() {
  ...
  module = angular.module('app', ['ngAnimate', 'ngRoute', 'ngSanitize', 'ngCookies', 'app.utilities', 'app.directives', 'app.services', 'app.controllers', 'filters', 'ui.grid', 'ui.grid.resizeColumns']);
